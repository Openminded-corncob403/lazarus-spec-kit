---
description: "Design Patterns (GoF) em FreePascal/Lazarus — Creational, Structural e Behavioral com Object Pascal"
globs: ["**/*.pas"]
alwaysApply: false
---

# Design Patterns GoF — Cursor Rules para FreePascal/Lazarus

Use estas regras ao implementar padrões de projeto em Object Pascal / FreePascal/Lazarus.
...
```pascal
// Singleton thread-safe em FreePascal/Lazarus
TAppConfig = class
private
...
## ✅ Checklist — Design Patterns em FreePascal/Lazarus
