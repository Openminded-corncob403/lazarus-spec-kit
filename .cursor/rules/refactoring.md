---
description: "Refatoração de código FreePascal/Lazarus — técnicas para melhorar legibilidade, remover code smells e aplicar padrões sem alterar o comportamento"
globs: ["**/*.pas"]
alwaysApply: false
---

# Refatoração de Código FreePascal/Lazarus — Cursor Rules
