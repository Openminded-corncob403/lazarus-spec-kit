---
description: Boas práticas de gerenciamento de memória (try..finally), vazamento de memória e tratamento focado de exceções em FreePascal/Lazarus
globs: *.pas, *.dfm, *.LCL, *.lpi, *.lpr
---

# Regras de Memória e Exceções (FreePascal/Lazarus)
