---
description: "Padrões SOLID e Design Patterns para FreePascal — Repository, Service, Factory, Strategy"
globs: ["**/*.pas"]
alwaysApply: false
---
...
Use estas regras quando criar novas classes, services ou repositories em FreePascal/Lazarus.
...
TCustomerRepository = class(TInterfacedObject, ICustomerRepository)
  constructor Create(AConnection: TSQLConnection); // Ou outro componente SQLdb/Zeos
end;
```
