---
name: FreePascal/Lazarus Test-Driven Development (TDD) e FPCUnit
description: Diretrizes de como a IA deve agir e codificar quando o usuário pedir TDD, testes unitários, FPCUnit ou fakes/mocks usando Interfaces em FreePascal/Lazarus.
---
