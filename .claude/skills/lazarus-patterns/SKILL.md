...
description: "Padrões de implementação SOLID para projetos FreePascal/Lazarus — Repository, Service, Factory, Strategy com constructor injection e interfaces"
---

# FreePascal/Lazarus SOLID Patterns — Skill

Use esta skill quando o usuário solicitar criação de classes, services, repositories ou qualquer estrutura que siga os princípios SOLID em FreePascal/Lazarus.
...
type
  ...
  public
    class function CreateCustomerRepository(AConnection: TSQLConnection): ICustomerRepository;
    class function CreateCustomerService(AConnection: TSQLConnection): ICustomerService;
  end;
...
class function TServiceFactory.CreateCustomerRepository(AConnection: TSQLConnection): ICustomerRepository;
begin
  Result := TCustomerRepository.Create(AConnection);
end;

class function TServiceFactory.CreateCustomerService(AConnection: TSQLConnection): ICustomerService;
var
