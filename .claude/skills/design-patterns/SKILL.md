---
name: "Design Patterns GoF — FreePascal/Lazarus"
description: "Implementação dos 23 padrões GoF (Gang of Four) em Object Pascal / FreePascal/Lazarus com interfaces, TInterfacedObject e princípios SOLID. Cobre Creational, Structural e Behavioral patterns."
---

# Design Patterns GoF em FreePascal/Lazarus — Skill

Use esta skill quando o usuário solicitar implementação de padrões de projeto (Design Patterns) em FreePascal/Lazarus. Aplique sempre junto com as convenções de nomenclatura (T/I/E/F/A/L) e gerenciamento de memória (try..finally).
...
- [ ] Testes FPCUnit cobrem cada padrão com Fakes/Stubs
