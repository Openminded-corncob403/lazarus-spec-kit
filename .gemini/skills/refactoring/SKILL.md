---
name: "Refatoração de Código FreePascal/Lazarus"
...
# Refatoração de Código FreePascal/Lazarus — Skill
...
private
  ...
  FRepository:  TSQLdb/ZeosOrderRepo;     // classe concreta
public
...
begin
  ...
  FRepository  := TSQLdb/ZeosOrderRepo.Create(GetDatabaseConnection);
end;
```
